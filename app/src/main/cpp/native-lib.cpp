...
#define JNI_API(name) Java_com_uiuang_opencv4demo_jni_BitmapOperation_##name
enum Operation {
    GRAY1, GRAY2, GRAY3, REVERSE, REMOVEB, REMOVEG, REMOVER, BRIGHTNESS, CONTRAST
};

//https://github.com/myml666/BitmapOperation
extern "C" {

void operationBitmap(JNIEnv *env, jobject bitmap, Operation operation, int brightness, float contrast);

JNIEXPORT void JNICALL JNI_API(bitmapGray1)(JNIEnv *env, jclass instance,
                                            jobject bitmap) {

    operationBitmap(env, bitmap, GRAY1, 0, 1);
}
JNIEXPORT void JNICALL JNI_API(bitmapGray2)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, GRAY2, 0, 1);
}
JNIEXPORT void JNICALL JNI_API(bitmapGray3)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, GRAY3, 0, 1);
}
JNIEXPORT void JNICALL JNI_API(bitmapReverse)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, REVERSE, 0, 1);
}

JNIEXPORT void JNICALL JNI_API(bitmapRemoveB)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, REMOVEB, 0, 1);
}

JNIEXPORT void JNICALL JNI_API(bitmapRemoveG)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, REMOVEG, 0, 1);
}

JNIEXPORT void JNICALL JNI_API(bitmapRemoveR)(JNIEnv *env, jclass instance, jobject bitmap) {
    operationBitmap(env, bitmap, REMOVER, 0, 1);
}

JNIEXPORT void JNICALL
JNI_API(bitmapBrightness)(JNIEnv *env, jclass instance, jobject bitmap, jint brightness) {
    operationBitmap(env, bitmap, BRIGHTNESS, brightness, 1);
}

JNIEXPORT void JNICALL
JNI_API(bitmapContrast)(JNIEnv *env, jclass instance, jobject bitmap, jfloat contrast) {
